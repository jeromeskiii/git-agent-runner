...
class AWSSecretsManagerProvider(SecretProvider):
    def __init__(self):
        try:
            ...
            get_logger().exception(f"Failed to initialize AWS Secrets Manager Provider")
            raise e
    ...
    def get_all_secrets(self) -> dict:
        ...
        try:
            ...
            get_logger().exception(f"Failed to get secrets from AWS Secrets Manager {self.secret_arn}")
            return {}
    ...
    def store_secret(self, secret_name: str, secret_value: str):
        try:
            ...
            get_logger().exception(f"Failed to store secret {secret_name} in AWS Secrets Manager")
            raise e 
