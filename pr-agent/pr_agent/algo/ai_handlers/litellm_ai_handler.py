...
class LiteLLMAIHandler(BaseAiHandler):
    ...
    def _init_aws_bedrock(self):
        """Initialize AWS Bedrock configuration with IMDS support."""
    ...
    def _init_replicate(self):
        """Initialize Replicate configuration."""
    ...
    def _init_google_ai_studio(self):
        """Initialize Google AI Studio (Gemini) configuration."""
    ...
    def _init_deepinfra(self):
        """Initialize DeepInfra configuration."""
    ...
    async def chat_completion(self, model: str, system: str, user: str, temperature: float = 0.2, img_path: str = None):
        ...
        async with (self._aws_bedrock_lock if _bedrock_imds else contextlib.nullcontext()):
            ...
            try:
                ...
                get_logger().exception(f"Rate limit error during LLM inference")
                raise
