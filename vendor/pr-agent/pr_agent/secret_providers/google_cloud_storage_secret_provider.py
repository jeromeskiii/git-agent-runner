...
class GoogleCloudStorageSecretProvider(SecretProvider):
    def __init__(self):
        try:
            ...
            get_logger().exception(f"Failed to initialize Google Cloud Storage Secret Provider")
            raise e
    ...
    def store_secret(self, secret_name: str, secret_value: str):
        try:
            ...
            get_logger().exception(f"Failed to store secret {secret_name} in Google Cloud Storage")
            raise e
