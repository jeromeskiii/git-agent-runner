...
class GithubProvider(GitProvider):
    ...
    def _get_diff_files(self) -> list[FilePatchInfo]:
        try:
            ...
            try:
                ...
                get_logger().exception(f"Failed to get merge base commit")
            ...
            get_logger().exception(f"Failing to get diff files",
    ...
    def publish_inline_comments(self, comments: list[dict], disable_fallback: bool = False):
        try:
            ...
            try:
                ...
                get_logger().exception(f"Failed to publish inline code comments fallback, error")
                raise e    
    ...
    def _try_fix_invalid_inline_comments(self, invalid_comments: list[dict]) -> list[dict]:
        ...
        for comment in invalid_comments:
            try:
                ...
                get_logger().exception(f"Failed to fix inline comment, error")
    ...
    def publish_code_suggestions(self, code_suggestions: list) -> bool:
        ...
        try:
            ...
            get_logger().exception(f"Failed to publish code suggestion, error")
            return False
    ...
    def publish_file_comments(self, file_comments: list) -> bool:
        try:
            ...
            get_logger().exception(f"Failed to publish diffview file summary, error")
            return False
    ...
    def validate_comments_inside_hunks(self, code_suggestions):
        ...
        for suggestion in code_suggestions_copy:
            try:
                ...
                get_logger().exception(f"Failed to process patch for committable comment, error")
