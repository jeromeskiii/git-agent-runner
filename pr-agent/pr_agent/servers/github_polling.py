...
def process_comment_sync(pr_url, rest_of_comment, comment_id):
    try:
        ...
        get_logger().exception(f"Error processing comment", artifact={"traceback": traceback.format_exc()})
    ...
    async with aiohttp.ClientSession() as session:
        while True:
            try:
                ...
                get_logger().exception(f"Polling exception during processing of a notification",
