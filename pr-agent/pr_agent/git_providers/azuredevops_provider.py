    ...
    def publish_code_suggestions(self, code_suggestions: list) -> bool:
        ...
        for suggestion in code_suggestions:
            ...
            try:
                ...
                get_logger().exception(f"Azure failed to publish code suggestion, error", suggestion=suggestion)
        return True
    ...
    def get_repo_settings(self):
        try:
            ...
            if get_settings().config.verbosity_level >= 2:
                get_logger().exception(f"Failed to get repo settings, error")
            return ""
    ...
    def _get_azure_devops_client() -> Tuple[GitClient, WorkItemTrackingClient]:
        ...
        if pat:
            ...
            try:
                ...
                get_logger().exception(f"No PAT found in settings, and Azure Default Authentication failed, error")
                raise
