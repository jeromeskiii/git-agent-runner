...
def extract_ticket_links_from_pr_description(pr_description, repo_path, base_url_html='https://github.com'):
    ...
    try:
        ...
        get_logger().exception(f"Error extracting tickets ",
...
def extract_ticket_links_from_branch_name(branch_name, repo_path, base_url_html="https://github.com"):
    ...
    if custom_regex_str:
        try:
            ...
            get_logger().exception(f"Invalid custom regex for branch issue extraction")
            return []
    else:
        pattern = BRANCH_ISSUE_PATTERN
            ...
            if tickets:
                ...
                for ticket in tickets:
                    ...
                    try:
                        ...
                        get_logger().exception(f"Error getting main issue",
                                           artifact={"traceback": traceback.format_exc()})
                        continue
                    ...
                    try:
                        ...
                        get_logger().exception(f"Error extracting labels ",
                                           artifact={"traceback": traceback.format_exc()})
